...
# Using the new Linear Node reduced the number of nodes used by two
lin_node1 = Linear(w1_node,x1_node,w0_node)
lin_node2 = Linear(w2_node,x2_node,lin_node1)
sigmoid = Sigmoid(lin_node2)
loss = BCE(y_node, sigmoid)

# Create graph outside the training loop
graph = [x1_node,x2_node,w0_node,w1_node,w2_node,lin_node1,lin_node2,sigmoid,loss]
